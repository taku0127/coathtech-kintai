...
class AttendanceRequest extends FormRequest
{
    ...
    public function messages(){
        $messages = [
            ...
            'break_time.start.*.after_or_equal' => '休憩時間が勤務時間外です / 出勤時間もしくは退勤時間が不適切な値です',
            'break_time.start.*.before_or_equal' => '休憩時間が勤務時間外です / 出勤時間もしくは退勤時間が不適切な値です',
            'break_time.end.*.required' => '休憩終了時間を入力してください。',
            'break_time.end.*.date_format' => '休憩終了時間は「00:00」形式で入力してください。',
            'break_time.end.*.before_or_equal' => '休憩時間が勤務時間外です / 出勤時間もしくは退勤時間が不適切な値です',
            'break_time.end.*.after_or_equal' => '休憩時間が勤務時間外です / 出勤時間もしくは退勤時間が不適切な値です',
